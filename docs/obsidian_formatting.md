...
## 1. Обзор
Для разметки, Obsidian использует [[Синтаксис Markdown|синтаксис Markdown]], за
исключением таких элементов, как: пользовательские идентификаторы заголовков,
...
[[#2. Внутренние ссылки|внутренней ссылки]]. Ко вставке допускаются любые файлы
форматов,
...
[[#2. Внутренние ссылки|механизм внутренних ссылок]]. Во время печати имени
...
[[Синтаксис Markdown#6. Цитаты|цитаты]]).
